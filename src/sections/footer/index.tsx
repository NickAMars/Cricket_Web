...
import { CopyRightLicense, EndingFooterStyle, FirstFooterStyle, FootContain, FooterAncher, FooterAncherContainer, FooterAncherText, FooterHeader, FooterStyle, JoinContain, JoinMedia, SecondFooterStyle, SignUpContainer, SignUpDescr, SignUpTitle } from "./footer.style"
    ...
    return <FooterStyle>
                ...
                <EndingFooterStyle>
                    <SecondFooterStyle>
                        ...
                        <FootContain>
                            <FooterHeader variant="subtitle1"> Legal </FooterHeader>
                            <FooterAncherContainer>
                    ...
                    <CopyRightLicense variant="body1"> © 2024 Cricket Wireless LLC. All rights reserved. </CopyRightLicense>
                </EndingFooterStyle>
            </FooterStyle>
}